# Atlas — Terms & Conditions (DRAFT v2)

> **⚠️ DRAFT — NOT LEGAL ADVICE.** AI-generated draft for internal review. It has **not** been reviewed by a qualified lawyer and must be before it is published to `myatlas.fit/terms`. Items in `[[double brackets]]` are decisions/placeholders for the owner or a lawyer to complete.
>
> **v2 changelog:** incorporates a 6-hat legal/product review of v1 (30 confirmed findings) — a consumer-vs-business liability split, a controller/processor data model, and new indemnity, app-store, force-majeure, notices and complaints clauses, plus factual fixes.
>
> **Assumptions & open items to confirm:**
> - **Governing law:** Cyprus (Cyprus law + EU law).
> - **Provider:** Aris Panayiotou, sole trader, trading as "Atlas". `[[Add a Cyprus contact/business address if required for consumer terms / app stores.]]`
> - ✅ **Privacy Policy** has been re-based to EU GDPR + the Cyprus Commissioner (was UK/ICO), and the minimum age is now **14** in both documents (resolved #21).
> - ⚠️ **Still needs a lawyer:** (1) a proper **Article 28 data-processing agreement** for Operators, and a matching update to the Privacy Policy so Atlas is not described as *sole* controller of Operator-managed Member data (see §13); (2) the **health / special-category (Art. 9) basis** (§12); (3) final **liability caps** and the **Apple EULA** specifics (§14, §11).
> - **After-year pricing:** kept open ("then-current plan and prices"), in EUR.
...
Some terms differ depending on whether you are a **Member** (an individual consumer using the app) or an **Operator** (a business). Where that's the case, it's stated. Read these Terms together with our **[Privacy Policy](/privacy)**.
...
- **Content** — material created or uploaded through Atlas (e.g. programs, templates, gym details, logos). "Content" does **not** include personal data such as workout logs, which is governed by data-protection law and the Privacy Policy (see §13).
...
- You must be at least **14** — the age of digital consent in Cyprus under the GDPR (Law 125(I)/2018) — to use Atlas, and at least **18** to open an Operator account or accept the Founding Partner offer. `[[If you serve EU markets with a higher digital-consent age (up to 16), state the highest applicable age or a per-country rule.]]`
...
- You agree to give accurate information and keep it up to date — including a current email address, which we use for notices (see §19).

## 4. The Service

Atlas is a fitness platform. Depending on your role, it lets you:

- **Operators:** publish and assign programs, schedule classes, take bookings, **set up, assign and track** session passes (packs or memberships — Members pay for these **offline**, see §7), run challenges, invite members, and manage your roster.
...
- Where fees become payable to us for a paid Operator plan (after any free period), they'll be at our **then-current prices**, notified in advance. `[[Insert billing mechanics — invoicing, currency (EUR), taxes/VAT — once the paid plan is defined.]]`
...
Atlas is provided on an "**as is**" and "**as available**" basis, especially during early access. We don't guarantee it will be uninterrupted or error-free, or that any feature will remain available. We may modify, suspend, or discontinue parts of the Service; where a change materially and adversely affects a Member's use, §18 (changes) and your statutory rights apply.
...
- For Member personal data that an **Operator** collects or manages through Atlas (e.g. assigning programs, managing rosters and passes), the **Operator is the controller and Atlas acts as a processor** on the Operator's documented instructions. A data-processing agreement under **GDPR Article 28** applies to Operators. `[[Add/annex the Art. 28 DPA — scope, instructions, confidentiality, security, sub-processors (Render, Cloudflare R2, Resend, Firebase, Sentry), and return/deletion on termination — and update the Privacy Policy so Atlas is not described as sole controller of Operator-managed data.]]`
- Some data (e.g. injuries, or data handled by physiotherapy Operators) may be **health / special-category data (GDPR Art. 9)**, which needs a specific Art. 9 condition. `[[Confirm the basis — explicit consent, and/or processing solely on Operator instruction — and reflect it in the Privacy Policy; alternatively state that users must not enter health data.]]`
- **Exercising your rights:** for data Atlas controls, contact us (§22); for data an Operator controls, contact that Operator, and we will assist as processor.
...
**14A. If you are a Member (consumer).** We provide the app with reasonable care and skill. Where EU consumer law (including the Digital Content Directive (EU) 2019/770 as implemented in Cyprus) gives you conformity and remedy rights, those rights apply and are not excluded by the "as is" wording in §10. We do **not** exclude liability for direct loss you suffer, including loss of your workout history/data, where it results from our breach. We are not liable for loss that was not reasonably foreseeable, or for content or advice provided to you by an Operator or another user.

**14B. If you are an Operator (business).** To the extent permitted by law, we are not liable for loss of profits, revenue, business, goodwill, or data, or for any indirect or consequential loss; and our total liability arising out of or in connection with the Service is limited to `[[the greater of the fees you paid us in the 12 months before the claim, or €100 — confirm cap]]`. You are responsible for your own dealings with your Members, including offline payments and the advice and programs you deliver (see §8, §15).

## 15. Indemnity

If you are an **Operator**, you will indemnify us against reasonable losses, damages, and costs (including reasonable legal fees) arising from third-party claims (including claims by your Members) relating to: (a) your processing of Member personal data; (b) your offline payment, pricing, or refund dealings; (c) the programs, content, or advice you deliver through Atlas, including any injury claim; and (d) intellectual property in material you upload. All users will indemnify us against claims arising from their breach of §8 or of the content warranties in §9. This section survives termination. (Consumers' liability is governed by §14A and applicable law, not by this indemnity.)

## 16. Events outside our control (force majeure)

We are not in breach of these Terms, and our obligations are suspended for the duration of the event, if performance is prevented or delayed by events beyond our reasonable control — including failures of third-party hosting, connectivity, or sub-processors (e.g. Render, Cloudflare, Firebase), power or internet outages, strikes, or natural events. If the event continues for a prolonged period, either of us may end the affected part of the arrangement on notice.
...
- **On termination or suspension**, your right to use the Service ends. We handle personal data in line with the **[Privacy Policy](/privacy)**. `[[The Privacy Policy currently addresses only voluntary account deletion — add retention/return/deletion rules for (i) involuntary termination/suspension, and (ii) Member data an Operator entered when that Operator's account ends, including whether independent Members keep their data.]]`
- **Survival:** any provision that by its nature is intended to survive termination continues to apply — including the fee/ledger and payment disclaimers (§7), Content and IP terms (§9), the health disclaimer (§12), data-protection roles (§13), the liability limits (§14), the indemnity (§15), governing law/disputes (§20), and the general terms (§21).
...
- **For Members (consumers):** we may change these Terms or the Service for a valid reason (for example legal or regulatory change, security, a change to a feature, or to reflect new functionality). For any change that materially and adversely affects you, we'll give you **at least `[[30]]` days' prior notice** (see §19) and you may **reject the change and close your account without penalty** before it takes effect. Changes required by law may take effect sooner.
...
- **Complaints first.** If something's wrong, email **aris@myatlas.fit** — we aim to acknowledge within `[[5 business days]]` and resolve complaints promptly. If you are a consumer, you keep your statutory rights and may also contact the **Cyprus Consumer Protection Service** or another competent alternative-dispute-resolution body. `[[Confirm any ADR entity you're willing to use. Note: the EU Online Dispute Resolution platform closed on 20 July 2025 — do not reference it.]]`
...
- **Entire agreement** — these Terms, the Privacy Policy, and (for Operators) any data-processing agreement or plan terms are the whole agreement between us about the Service.
